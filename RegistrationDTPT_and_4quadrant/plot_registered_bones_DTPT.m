...
legendname={'S17 m2 wt', 'S84 m3 wt','S18 m2 mt', 'S17 m1 mt','S84 m1 mut','S84 m5 mt','S18 m6 wt','S51 m2 wt','S84 m4 wt'};
...
h1=figure;
count=1;
for i=[1,5];%put all the bone here one by one to check alignment with sample 1 
    data=load(['/home/student/ankit_code_paul_maps_registration/data/',dt_data_path{i},'AlignedXYZ.mat']);
    vec=data.vec;
...
%          vec=vec*RotationMatrix_Z(270/180*pi);
%     end

    if i==2 
         vec=vec*RotationMatrix_X(pi);
    end
