...
% MATLAB 2016a version does not work 
...
path_distal='data\Nuclei_and_Cells_PH_S93_m2_mut_E18.5\';
path_proximal='';
...
if ignore_distal==true
    ...
    start=0;
     for position = coordinates(:,1)'      
        a=load(strcat(distal_data_path,'c_n_pos',sprintf('%02d',position),' (Characteristics).mat'));
...
if ignore_proximal==true
      ...
      proximal_data_path=path_proximal;
