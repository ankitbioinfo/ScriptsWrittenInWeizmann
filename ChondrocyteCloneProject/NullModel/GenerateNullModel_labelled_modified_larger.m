...
radius=load('../Tibia/dataSave/ParameterForRandomModel_basedon_nuc_larger.dat');
randomCellCutoff=cell_cutoff(:,3);
[~,LCC]=readClusterFile('../Tibia/MakeListColumnarStructurePrediction/ClusterLargerCutoff.dat');
disp('LCC')
length(LCC)
...
dir2=strcat('Realization_larger','/');
if ~exist([dir2],'dir')
    mkdir([dir2]);
end
