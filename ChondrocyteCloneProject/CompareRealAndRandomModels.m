...
savename={'clusterVolume' ,'clusterSurfaceArea','clusterSize','clusterSphericity',  ...
          ...
          'biaxial_S','biaxial_P','biaxial_D','biaxial_C',  'AngleBetweenClusterPC1AndBone_PD' ,'coordination_number','diameter', 'randomWalktheory'};
  ...
  '<cluster PC1>','<cluster PC2>','<cluster PC3>','<cluster PC2/PC1>','<cluster PC3/PC1>','<cluster PC3/PC2>', '<R_g>',...
   ...
   '<Global OOP 1>','<Global OOP 2>','<Global OOP 3>',  '<angle(plane, P-D axis)>','<angle(plane,PC1)>',...
            '<angle(plane, PC2)>', '<angle(plane,PC3)>', '<largest eigenvalue of Hessian>', '<smallest eigenvalue of Hessian>',...
             '<cluster radius>', '< OOP S>', '< OOP P>', '< OOP D>', '< OOP C>', '<\alpha>','<coordination number>','<diameter>','<R_g>'};
...
%                                  LCC: {1?481 cell}
%                               volume: [481?1 double]
%                         surface_area: [481?1 double]
%                          clusterSize: [481?1 double]
%                        clusterRadius: [481?1 double]
%     AngleBetweenClusterPC1AndBone_PD: [481?1 double]
%                           clusterPC1: [481?1 double]
%                           clusterPC2: [481?1 double]
%                           clusterPC3: [481?1 double]
%                                  LOP: [481?3 double]
%                                  GOP: [481?3 double]
%                         LocalBiaxial: [481?4 double]
%                                   rg: [481?1 double]
%                          coordNumber: [481?1 double]
%                             diameter: [481?1 double]
%                      averageStepSize: [481?1 double]
%                         highest_mode: [481?1 double]
%                        smallest_mode: [481?1 double]
%            plane_of_division_to_cell: [481?3 double]
%            plane_of_division_to_bone: [481?1 double]
%                           sphericity: [481?1 double]
%                    clusterPC2_by_PC1: [481?1 double]
%                    clusterPC3_by_PC1: [481?1 double]
%                    clusterPC3_by_PC2: [481?1 double]
%                       VolumeFraction: [481?1 double]
    ...
    for j=1:Col
        ...
        if chro==2
               ...
               for realization=1:100
                ...
                fractalCalculation( data, Xbin)
                title('background clusters','fontweight','normal') 
        end
...
print([dir2,'comparison_fractalDimension.png'],'-dpng','-r150')
close all 
end
...
function fractalCalculation( mydata, Xbin)  
    ...
    for i=1:length(zone)
        ...
        Df=1/f.m; 
        lname{i}=[legname{i},': ', 'D_f =',sprintf('%0.2f',Df)];
    
    end

        legend(p, lname,'location','southeast','fontsize',8)
