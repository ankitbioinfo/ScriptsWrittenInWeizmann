...
allpath={'../data/Nuclei_and_Cells_DT_E18.5/'};
...
for gi=1%:length(allpath)
        ...
        outputpath=strcat('MakeListColumnarStructurePrediction/','');    
...
scount=1;
for position = [2:20,22:30,33]   %coordinates(:,1)'  
...
save([outputpath,'centroid_and_surface_cells.mat'],'nuc','centroid','celvolume','unique_pixel','fitellipsoid','unique_tileid','-v7.3');
      else
             load([outputpath,'centroid_and_surface_cells.mat'],'centroid');
      end
