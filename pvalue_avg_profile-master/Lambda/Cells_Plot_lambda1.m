...
h1=figure();
XL=0.05;XR=0.03;XGap=0.05;Row=1;
YT=0.06;YB=0.1;YGap=0.07;Col=3;
...
for i=1:Row
    ...
    for j=1:Col
        ...
        legendarray2{1}=tname{chro};
        hold on 
      
        p(2)=plot(myinterval,nucavg,strcat('b','-'),'linewidth',0.2);
        legendarray2{2}=tname{chro};
        
        p(3)=plot(myinterval,cel3avg,strcat('k','-'),'linewidth',0.2);
        legendarray2{3}=tname{chro};
...
if testwithstd==2
saveas(h1,['Cells_PC_coeff1']);
saveas(h1,['Cells_PC_coeff1.png']);
end
