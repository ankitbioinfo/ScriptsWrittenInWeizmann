...
a2=load('../CreateMatFiles/avg_PC2_PC3.mat');
a1=load('../CreateMatFiles/avg_PC1_PC3.mat');
...
for i=1:Row
    ...
    for j=1:Col
        ...
        if chro<6
            ...
            cel2=a2.data{bonetype}.cel;
            cel1=a1.data{bonetype}.cel;
            ...
            celavg=nanmean(cel1,2);
            nucavg=nanmean(cel2,2);
            celstd=(nanstd(cel1'))';
            nucstd=(nanstd(cel2'))';
            ...
            legendarray2{1}=strcat('PC1/PC3');
            legendarray2{2}=strcat('PC2/PC3');
...
%        
        ...
        ylabel('different ratio','fontsize',14); 
...
%saveas(h1,['RatioPCs']);
saveas(h1,['normalizedRatioPCs.png']);
