...
%                   end
             ...
             b(2)=max(region(:,2));
               ...
               plot(x,output.yfit,'k-','linewidth',0.6);
               text(x(1),0.12, ['Y = ',sprintf('%0.2f',output.p(1)),'X + ',sprintf('%0.2f',output.p(2))],'fontsize',6)
               text(x(1),0.10, ['R^2 = ', sprintf('%0.2f',output.Rsq1)],'fontsize',6)
               text(x(1),0.08, ['pvalue = ', sprintf('%0.2e',output.pvalue)],'fontsize',6)
               
               %index=unique(index)
               index=1+limit1:limit2;
               x=(myinterval(index))';y=celavg(index);
               output=errorAndPvalue(x,y);                               
               plot(x,output.yfit,'b-','linewidth',1);
               text(x(1),0.38, ['Y = ',sprintf('%0.2f',output.p(1)),'X + ',sprintf('%0.2f',output.p(2))],'color','b')
               text(x(1),0.35, ['R^2 = ', sprintf('%0.2f',output.Rsq1)],'color','b')
               text(x(1),0.32, ['pvalue = ', sprintf('%0.2e',output.pvalue)],'color','b')
               
               
               index=limit2+1:limit3;
               x=(myinterval(index))';y=celavg(index);
               output=errorAndPvalue(x,y); 
               plot(x,output.yfit,'m-','linewidth',1);
               text(x(1),0.22, ['Y = ',sprintf('%0.2f',output.p(1)),'X + ',sprintf('%0.2f',output.p(2))],'fontsize',6,'color','m')
               text(x(1),0.20, ['R^2 = ', sprintf('%0.2f',output.Rsq1)],'fontsize',6,'color','m')
               text(x(1),0.18, ['pvalue = ', sprintf('%0.2e',output.pvalue)],'fontsize',6,'color','m')
               [output.p(1) output.pvalue]
               ...
               text(x(1),0.12, ['Y = ',sprintf('%0.2f',output.p(1)),'X + ',sprintf('%0.2f',output.p(2))],'fontsize',6)
               text(x(1),0.10, ['R^2 = ', sprintf('%0.2f',output.Rsq1)],'fontsize',6)
               text(x(1),0.08, ['pvalue = ', sprintf('%0.3f',output.pvalue)],'fontsize',6)
...
if testwithstd==2
saveas(h1,['Allometric_Volume2SurfaceArea_test_cellMT']);
saveas(h1,['Allometric_Volume2SurfaceArea_test_cellMT.png']);
end
